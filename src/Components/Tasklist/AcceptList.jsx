...
const AcceptList = ({ data,onDelete }) => {
  return (
    <div className="rounded-2xl bg-white/10 p-6 shadow-xl backdrop-blur-md">
      <div className="mb-5 flex items-center justify-between">
        ...
        <h2 className="text-l font-bold text-white">{data.date}</h2>
      ...
      <div className="min-h-[260px] rounded-xl border border-dashed border-white/20 bg-slate-950/20 p-4 flex flex-col">
        ...
        <div className='flex justify-center gap-4 mt-auto pt-4'>
          <button className="rounded-full bg-green-700 px-4 py-1 text-sm text-white/80 text-l font-bold text-white">Accept</button>
          <button className="rounded-full bg-red-700  px-4 py-1 text-sm text-white/80 text-l font-bold text-white">Reject</button>
